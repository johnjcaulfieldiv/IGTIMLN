...
class Life():
    ...
    def update(self):
        ...
        self.cells = ['*' if self.lives(cell, self.get_neighbor_counts(index)) else ' ' for index, cell in enumerate(self.cells)]
    ...
    def lives(self, cell, living_neighbors):
        """ Returns True if cell is living or False if cell is dead based on living neighbors """
        return (cell == '*' and (living_neighbors[0] == 2 or living_neighbors[0] == 3) or
            cell == ' ' and living_neighbors[0] == 3)
...
def main():
    ...
    Life(55,80).auto_n_generations(50, 50)
